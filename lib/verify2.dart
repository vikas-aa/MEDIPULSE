...
class MyVerifyTwo extends StatefulWidget {
  final String verificationId;
  const MyVerifyTwo({Key? key,required this.verificationId}): super(key: key);

  @override
  State<MyVerifyTwo> createState() => _MyVerifyTwoState();
}

class _MyVerifyTwoState extends State<MyVerifyTwo> {
